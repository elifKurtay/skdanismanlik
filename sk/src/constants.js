export const ILETISIM = {
    title: "BIZE ULAŞIN!",
    alt: "Hizmetlerimiz hakkında daha detaylı bilgi almak için aşağıdaki e-posta adresinden iletişime geçebilirsiniz.",
    email: "skurtay@skdanismanlik.net",
    footer: "SK Danışmanlık © 2020"
}
